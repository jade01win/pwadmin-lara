                                ...
                                <nav>
                                    ...
                                    <div class="navbar-wrap d-none d-lg-flex">
                                        <ul class="left">
                                            ...
                                            <li><a href="game-overview.html">Guide</a></li>
                                            <li><a href="community.html">Community</a></li>
                                        </ul>
                                        <div class="logo">
                                            <a href="index-3.html"><img src="img/logo/perfect-world-international.png" alt="Logo"></a>
                                        </div>
                                        <ul class="right">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="third-banner-img wow bounceInDown" data-wow-delay=".2s">
                                <img src="img/slider/characters.png" alt="" width="800px">
                            </div>
                            <div class="third-banner-content text-center wow bounceInUp" data-wow-delay=".2s">
                                <h2>PERFECT<span>WORLD</span></h2>
                                <h4>XXX</h4>
                                <a href="#" class="btn rotated-btn">PLAY Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 order-0 order-lg-2">
                            <div class="third-about-img text-right position-relative">
                                <img src="img/blog/thumb-800-93030.jpg" class="main-img" alt="">
                        ...
                        <div class="col-lg-6">
                            <div class="third-about-content">
                                <div class="third-title-style">
                                    <h2>Welcome to <span>Perfect World</span></h2>
                                    <div class="inner">
                                        <h2>Warsoul</h2>
                                        <h6 class="vertical-title">perfectworld</h6>
                                        <p>Perfect World is a 3D adventure and fantasy MMORPG with traditional Chinese settings. The game allows players to take on various roles depending on their choice of race and class within that race.</p>
                                    </div>
                                    <a href="#" class="btn rotated-btn">play Now</a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="third-section-title text-center mb-75">
                                    <h2>see <span>server</span> information</h2>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="my-info-box-content">
                                        <div class="my-clan-wrap">
                                            <div class="my-clan-info">
                                                <h4><span>over 75+</span> registered users</h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row game-gallery-active">
                        <div class="col-12">
                            <div class="game-gallery-item">
                                <img src="img/blog/PWI-Screenshot-02.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="game-gallery-item">
                                <img src="img/blog/perfect-world-2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="game-gallery-item">
                        ...
                        <div class="col-12">
                            <div class="game-gallery-item">
                                <img src="img/blog/239565.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="my-match-area my-match-bg pb-120">
                <div class="container custom-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="third-section-title text-center mb-75">
                                <h2>see last <span>Teritorial</span> war</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="third-contact-wrap">
                                <div class="third-title-style">
                                    ...
                                    <a href="#" class="btn rotated-btn">DONATE Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="copyright-text">
                                <p>Copyright © 2023 <a href="#">@kirimito403</a> All Rights Reserved.</p>
                            </div>
                        </div>
